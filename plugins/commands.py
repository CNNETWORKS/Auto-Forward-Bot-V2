...
main_buttons = [[
        InlineKeyboardButton('Main Channel', url='https://t.me/cnnetworkofficial')
        ],[
        InlineKeyboardButton('📜 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ ', url='https://t.me/+ctTkbDU_di9lYWE1'),
        InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ  ', url='https://t.me/cnnetworkofficial')
        ],[
